    ...
    <>
      <div>
        ...
        <div className="flex sm:space-x-24">
          <div className="hidden h-full max-h-screen min-w-[280px] max-w-[280px] flex-wrap overflow-auto rounded-lg bg-warm-100 pt-5 shadow-sm dark:bg-warm-900 sm:flex">
            <div className="px-6 py-4">
              {pathname.startsWith('/blog') ? (
                ...
                <Link
                  href={`/blog`}
                  className="font-bold uppercase text-warm-700 transition-colors duration-200 hover:text-accent-500 dark:text-warm-300 dark:hover:text-accent-400"
                >
                  All Posts
                </Link>
              )}
                  ...
                  return (
                    <li key={t} className="my-3">
                      {pathname.split('/tags/')[1] === slug(t) ? (
                        ...
                        <Link
                          href={`/tags/${slug(t)}`}
                          className="px-3 py-2 text-sm font-medium uppercase text-warm-500 transition-colors duration-200 hover:text-accent-500 dark:text-warm-400 dark:hover:text-accent-400"
